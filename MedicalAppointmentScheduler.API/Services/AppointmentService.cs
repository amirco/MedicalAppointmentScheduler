...
public class AppointmentService
{
    ...
    private static readonly TimeSpan GENERATE_ALTERNATIVE_WORK_START = new TimeSpan(8, 0, 0);
    private static readonly TimeSpan GENERATE_ALTERNATIVE_WORK_END = new TimeSpan(17, 0, 0);
    ...
    public async Task<(Appointment appointment, List<DateTime> alternativeTimes)> CreateAppointmentAsync(Appointment appointment)
    {
        ...
        try
        {
            ...
            if (alternativeTimes != null)
                return (appointment, alternativeTimes);

            // Ensure ID is not set (will be generated by database)
            appointment.Id = 0;
            
            var res = _context.Appointments.Add(appointment);
            await _context.SaveChangesAsync();
            return (res.Entity, new List<DateTime>());
        }
        finally
        {
            _lock.Release();
